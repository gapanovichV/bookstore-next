      ...
      <div className={clsx("container", styles.header__container)}>
        ...
        <button className={clsx("btn-reset")} onClick={() => router.back()}>
          <svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M21.8424 10.668L11.1758 21.3346" stroke="#1A1A1A" strokeWidth="1.5" strokeLinecap="round"
                  strokeLinejoin="round" />
            <path d="M11.1758 10.668L21.8424 21.3346" stroke="#1A1A1A" strokeWidth="1.5" strokeLinecap="round"
                  strokeLinejoin="round" />
          </svg>
        </button>
      </div>
